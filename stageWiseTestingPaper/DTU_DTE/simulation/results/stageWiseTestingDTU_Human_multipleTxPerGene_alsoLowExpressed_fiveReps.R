...
nrPerGroup=5
baseDir <- "/Volumes/HDKoen/data/dtu/diff_splice_paper_Kvdb/hsapiens/no_diffexpression/non_null_simulation/"
...
names(fastaFiles) <- rep(paste0("Hs_sample_",1:(nrPerGroup*2)),each=2)
...
#gene level
plot(x=evalGeneLevelSW[,"fdr"],y=evalGeneLevelSW[,"tpr"], type="n", xlab="FDR", ylab="TPR", ylim=c(0.2,1), bty="l", main="Human")
