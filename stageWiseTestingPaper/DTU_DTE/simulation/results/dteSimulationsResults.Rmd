...
# Combine FDP-TPR curves in one figure
...
plot(x=performanceDataHuman$fdrQval, y=performanceDataHuman$tprQval, type="l", ylab="True Positive Rate", xlab="False Discovery Proportion", ylim=c(0,1), lwd=2, main="", cex.lab=1.5, cex.axis=1.5)
abline(v=c(.01,.05,seq(.1,.9,.1)),col=alpha("grey",.5),lty=2)
