...
abline(v=c(0.01,0.05,0.1,seq(0.1,1,.1)), col=alpha("grey",.8), lty=2)
lines(x=cobraplotGene@fdrtprcurve$FDR,y=cobraplotGene@fdrtprcurve$TPR,col="orange",lwd=2)
points(x=cobraplotGene@fdrtpr$FDR,y=cobraplotGene@fdrtpr$TPR, col="white", pch=19, cex=1.2)
points(x=cobraplotGene@fdrtpr$FDR,y=cobraplotGene@fdrtpr$TPR, col="orange", pch="o", cex=1.2)
lines(x=cobraplotTx@fdrtprcurve$FDR,y=cobraplotTx@fdrtprcurve$TPR,col="steelblue",lwd=2)
points(x=cobraplotTx@fdrtpr$FDR,y=cobraplotTx@fdrtpr$TPR, col="white", pch=19, cex=1.2)
points(x=cobraplotTx@fdrtpr$FDR,y=cobraplotTx@fdrtpr$TPR, col="steelblue", pch="o", cex=1.2)
legend("bottomright",c("gene-level","transcript-level"),col=c("orange","steelblue"),lty=1, bty="n", cex=1.5)

#F1000: Human
par(bty="l", cex.axis=1.5, cex.lab=1.5, mar=c(5,4.5,4,1))
plot(x=cobraPlotGeneF1000@fdrtprcurve$FDR,y=cobraPlotGeneF1000@fdrtprcurve$TPR, type="l",col="orange",lwd=2, xlim=c(0,0.7), ylab="True Positive Rate", xlab="False Discovery Proportion", main="Human")
points(x=cobraPlotGeneF1000@fdrtpr$FDR,y=cobraPlotGeneF1000@fdrtpr$TPR, col="white", pch=19, cex=1.2)
points(x=cobraPlotGeneF1000@fdrtpr$FDR,y=cobraPlotGeneF1000@fdrtpr$TPR, col="orange", pch="o", cex=1.2)
lines(x=cobraPlotTxF1000@fdrtprcurve$FDR,y=cobraPlotTxF1000@fdrtprcurve$TPR,col="steelblue",lwd=2)
