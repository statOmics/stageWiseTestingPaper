...
resultsMatJiangDoerge01 <- matrix(NA,nrow=N,ncol=11)
colnames(resultsMatJiangDoerge01) <- c("overallFDR", "powerInteraction", "fdrInteraction", "fdrT1", "fdrT2", "fdrAllHyp", "powerT1", "powerT2", "nullGeneFDR", "nrFalsePositiveNullGenes", "totalGenesFound")
resultsMatJiangDoerge05 <- matrix(NA,nrow=N,ncol=11)
colnames(resultsMatJiangDoerge05) <- c("overallFDR", "powerInteraction", "fdrInteraction", "fdrT1", "fdrT2", "fdrAllHyp", "powerT1", "powerT2", "nullGeneFDR", "nrFalsePositiveNullGenes", "totalGenesFound")
resultsMatJiangDoerge10 <- matrix(NA,nrow=N,ncol=11)
colnames(resultsMatJiangDoerge10) <- c("overallFDR", "powerInteraction", "fdrInteraction", "fdrT1", "fdrT2", "fdrAllHyp", "powerT1", "powerT2", "nullGeneFDR", "nrFalsePositiveNullGenes", "totalGenesFound")
resultsMatJiangDoerge01Limma <- matrix(NA,nrow=N,ncol=11)
colnames(resultsMatJiangDoerge01Limma) <- c("overallFDR", "powerInteraction", "fdrInteraction", "fdrT1", "fdrT2", "fdrAllHyp", "powerT1", "powerT2", "nullGeneFDR", "nrFalsePositiveNullGenes", "totalGenesFound")
resultsMatJiangDoerge05Limma <- matrix(NA,nrow=N,ncol=11)
colnames(resultsMatJiangDoerge05Limma) <- c("overallFDR", "powerInteraction", "fdrInteraction", "fdrT1", "fdrT2", "fdrAllHyp", "powerT1", "powerT2", "nullGeneFDR", "nrFalsePositiveNullGenes", "totalGenesFound")
resultsMatJiangDoerge10Limma <- matrix(NA,nrow=N,ncol=11)
colnames(resultsMatJiangDoerge10Limma) <- c("overallFDR", "powerInteraction", "fdrInteraction", "fdrT1", "fdrT2", "fdrAllHyp", "powerT1", "powerT2", "nullGeneFDR", "nrFalsePositiveNullGenes", "totalGenesFound")
